...
const { customerSchema, updateCustomerSchema , getAllCustomerSchema} = require("../schemas/CRM/customerSchema");
const { swagger: updateQuoteSchema } = j2s(updateCustomerSchema);
const { swagger: getAllCustomerSchema } = j2s(getAllCustomerSchema);
