export const passwordTemplate = `<html lang='en'>
<head>
  <meta charset='UTF-8' />
  ...
  <div style='background-color: #f7f7f7'>
    <div style='width: 100%'>
      ...
      <p
        ...
        '
      >
        Your password is successfully updated, This is your Email:
        {{email}}
        and your Password for login is
      </p>
      <center>
        <button
          style='
      ...
      <p
        ...
        '
      >
        <img src='{{base_url}}/images/lock.png' width='40' />
    ...
    <center>
      <ul style='list-style: none; display: inline-flex'>
        <li style='margin: 10px'>
          <a href='#' target='blank'>
            <img src='{{base_url}}/images/instagram.png' width='60' /></a>
        </li>
        <li style='margin: 10px'>
          <a href='#' target='blank'>
            <img src='{{base_url}}/images/facebook.png' width='60' /></a>
        </li>
        <li style='margin: 10px'>
          <a href='#' target='blank'>
            <img src='{{base_url}}/images/telegram.png' width='60' /></a>
        </li>
        <li style='margin: 10px'>
          <a href='#' target='blank'>
            <img src='{{base_url}}/images/youtube.png' width='60' /></a>
        </li>
      </ul>
    </center>
  </div>
