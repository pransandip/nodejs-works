...
export const createNotification = async (
  ...
  try {
    return await prisma.chatNotification.create({
      data: chatMessagesNotificationData,
    });
  } catch (err) {
    console.log((err as Error).message);
  }
...
export const updateNotification = async (
  ...
  try {
    return await prisma.chatNotification.update({
      data: {
        notificationCount: chatMessagesNotificationData.notificationCount,
      },
      where: { id: id },
    });
  } catch (err) {
