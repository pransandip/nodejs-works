...
import {fetchChatMessagesData,sendChatMessage} from '../services/chatService';
...
const ChatInbox = (props) => {
  ...
  const getChatMessages = async ()=>{
    const messagesdata = await fetchChatMessagesData({senderId:auth.user.id,receiverId:props.receiver.id});
